...
export default function WorkPage() {
  return (
    <div className="maindivONE">
       <nav className="relative z-20 px-6 py-2 md:px-12 flex items-center justify-between max-w-[1460px] mx-auto">
        <div>
          <img
            className="w-28 h-auto rotate-360 hover:rotate-0 transition-transform duration-300"
            src="images\abhi-1.png"
          ></img>
        </div>
      ...
      <div className="maindiv flex-1 max-w-[1200px] mx-auto w-full px-6 py-16">
