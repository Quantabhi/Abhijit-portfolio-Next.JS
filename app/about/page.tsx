    ...
    <>
      <div className="maindiv bg-background-light  text-slate-800 dark:text-slate-200 transition-colors duration-300 min-h-screen flex flex-col ">
        <header className="p-8 md:p-12">
          <div className="headdiv flex justify-between items-start">
            {/* social media logo */}
            <div className="flex gap-6 items-center">
              <a aria-label="GitHub" className="social-icon" href="https://github.com/Quantabhi">
                <svg
                  className="w-6 h-6 fill-slate-400 hover:fill-black "
                  viewBox="0 0 24 24"
                >
              ...
              <a aria-label="LinkedIn" className="social-icon" href="https://in.linkedin.com/">
                <svg
                  className="w-6 h-6 fill-slate-400 hover:fill-black"
                  viewBox="0 0 24 24"
                >
              ...
              <a aria-label="X (Twitter)" className="social-icon" href="https://x.com/abhijitmondal22">
                <svg
                  className="w-6 h-6 fill-slate-400 hover:fill-black"
                  viewBox="0 0 24 24"
                >
              ...
              <a aria-label="Instagram" className="social-icon" href="https://www.instagram.com/mondalabhi23">
                <svg
                  className="w-6 h-6 fill-slate-400 hover:fill-black"
                  viewBox="0 0 24 24"
                >
            ...
            <nav className="flex gap-8 items-center font-bold text-[10px] tracking-[0.25em] text-slate-400  transition-colors duration-300">
              <Link className=" hover:text-black" href="/">
                HOME
              </Link>
              <Link className="hover:text-black" href="/work">
                WORK
              </Link>
              <a
